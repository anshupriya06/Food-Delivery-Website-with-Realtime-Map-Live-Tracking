        ...
        return (
            <div className='fixed top-3 left-0 w-full z-[9999] bg-[#fff9f6]'>
                <div className='max-w-[1800px] mx-auto h-[80px] flex items-center justify-center md:justify-center gap-[30px] px-[20px]'>
                    ...
                    {showSearch && <div className='w-[90%] h-[70px] bg-white shadow-xl rounded-lgn flex fixed top-[80px] left-[5%] items-center gap-[20px] md:hidden z-[9999]'>
                    ...
                    {/* search */}
                    <div className='md:w-[60%] lg:w-[40%] h-[70px] bg-white shadow-xl rounded-lg md:flex hidden items-center gap-[20px]'>
                    ...
                    <div className='flex items-center gap-[20px]'>
                        {showSearch ? <RxCross2 size={25} className='text-[#ff4d2d] md:hidden cursor-pointer' onClick={() => setShowSearch(false)} /> : <IoMdSearch size={25} className='text-[#ff4d2d] md:hidden cursor-pointer' onClick={() => setShowSearch(true)} />}
